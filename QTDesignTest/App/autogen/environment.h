...
Q_IMPORT_QML_PLUGIN(QTDesignTestContentPlugin)
Q_IMPORT_QML_PLUGIN(Generated_Bundles_EffectsPlugin)
Q_IMPORT_QML_PLUGIN(Generated_Bundles_MaterialsPlugin)
Q_IMPORT_QML_PLUGIN(QTDesignTestPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/QTDesignTestContent/App.qml";
