...
class InputGraph(QtWidgets.QWidget):
    ...
    # (degree control removed — spline degree is handled internally)
        ...
        self.start_y_spin.setStyleSheet("font-size: 14px; min-width: 90px; padding-right: 6px;")
        ...
        self.end_y_spin.setStyleSheet("font-size: 14px; min-width: 90px; padding-right: 6px;")
        ...
        self.ymin_spin.setStyleSheet("font-size: 14px; min-width: 90px; padding-right: 6px;")
        ...
        self.ymax_spin.setStyleSheet("font-size: 14px; min-width: 90px; padding-right: 6px;")
        ...
        self.xmin_spin.setStyleSheet("font-size: 14px; min-width: 90px; padding-right: 6px;")
        ...
        self.xmax_spin.setStyleSheet("font-size: 14px; min-width: 90px; padding-right: 6px;")
        ...
        self.max_points_spin.setStyleSheet("font-size: 14px; min-width: 90px; padding-right: 6px;")
